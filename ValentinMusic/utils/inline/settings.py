...
def setting_markup(_):
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(text="🗳️ " + _["ST_B_4"], callback_data="VM"),
        ],
        [
...
def vote_mode_markup(_, current, mode: Union[bool, str] = None):
    buttons = [
        [
            InlineKeyboardButton(text=_["ST_B_4"] + " ➜", callback_data="VOTEANSWER"),
...
def auth_users_markup(_, status: Union[bool, str] = None):
    buttons = [
        ...
        [
            InlineKeyboardButton(text="📜 Aᴜᴛʜᴏʀɪᴢᴇᴅ Usᴇʀs", callback_data="AUTHLIST"),
        ],
        [
            InlineKeyboardButton(
                text=_["BACK_BUTTON"],
...
def playmode_users_markup(
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(text=_["ST_B_2"] + " ➜", callback_data="AUTHANSWER"),
            InlineKeyboardButton(
        ...
        [
            ...
            InlineKeyboardButton(
                text="🏢 Group" if Playtype == True else "📢 Channel",
