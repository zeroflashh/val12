...
from ValentinMusic.utils.decorators.admins import ActualAdminCB
from ValentinMusic.utils.decorators.language import language, languageCB
from ValentinMusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from ValentinMusic.utils.theme import get_random_photo
from ValentinMusic.utils.inline.start import private_panel
from config import BANNED_USERS, OWNER_ID


async def update_settings_msg(CallbackQuery, _, buttons):
...
@app.on_callback_query(filters.regex(pattern=r"^(settings_helper|settingsback_helper|settings_back_helper)$") & ~BANNED_USERS)
@languageCB
async def settings_cb(client, CallbackQuery, _):
    ...
    # Otherwise, show the main settings panel with a random photo
    buttons = setting_markup(_)
    return await update_settings_msg(CallbackQuery, _, buttons)
