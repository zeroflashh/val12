...
from ValentinMusic.utils import extract_user, int_to_alpha
...
from ValentinMusic.utils.decorators import AdminActual, language
...
@app.on_message(
    filters.command(["authlist", "authusers", "authorized"]) & filters.group & ~BANNED_USERS
)
@language
